  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        <StatCard label="Total Value Locked" value="$12.4M" change="+8.3%" icon="💰" />
        <StatCard label="VERSE Price" value="$0.0842" change="+2.1%" icon="📈" />
        <StatCard label="Your Staked VERSE" value="125,000" change="+5.0%" icon="🛡" />
        <StatCard label="Rewards Earned" value="3,420 VERSE" change="+12.4%" icon="🏆" />
      </div>
        ...
        <div className="rounded-xl border border-gray-800 p-6 bg-gray-950">
          ...
          <div className="space-y-4">
            {[
              ...
              { label: "Pause Status", value: "Active", color: "bg-green-500" },
            ].map((item, i) => (
